      ...
      <div v-else class="data-list">
        <div v-for="record in records" :key="record.id" class="maintenance-item">
          ...
          <div class="item-body">
            ...
            <div class="info-item"><strong>备注:</strong> <span class="remark-text" :title="record.remark">{{ record.remark && record.remark.length > 20 ? record.remark.substring(0, 20) + '...' : (record.remark || '无') }}</span></div>
          </div>
