...
const initThreeJS = () => {
  ...
  const directionalLight = new THREE.DirectionalLight(0x3498db, 1.5); 
  ...
  loader.load(
    ...
    (gltf) => {
      ...
      const cameraY = Math.abs(boundingSize.z / 2 / Math.tan(fov / 2)) * 0.6;
      ...
      controls.maxDistance = cameraY * 1.2;
    },
    undefined,
    (error) => {
